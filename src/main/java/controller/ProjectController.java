     ...
     public List<Project> getAll() {
        ...
        try {
            ...
            while (rset.next()) {
                ...
                project.setName(rset.getString("nome"));
                project.setDescription(rset.getString("descricao"));
                project.setCreatedAt(rset.getDate("dataCriacao"));
                project.setCreatedAt(rset.getDate("dataAtualizacao"));
      ...
      public void update(Project project) {
        ...
        String sql = "UPDATE projects SET nome = ?, descricao = ?, dataCriacao = ?, dataAtualizacao = ? WHERE id = ?";
